...
```
git clone https://github.com/RobSenseTech/phenix_devkit
```
...
![Screenshot from 2017-03-13 15-47-10](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 15-47-10.png)

select three "I Agree" and Next

![Screenshot from 2017-03-13 15-50-30](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 15-50-30.png)

select third one, click Next

![Screenshot from 2017-03-13 15-50-56](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 15-50-56.png)

select "Software Development Kit (SDK)", click Next

![Screenshot from 2017-03-13 15-52-18](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 15-52-18.png)

choose installation directory, click Next

![Screenshot from 2017-03-13 16-00-03](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 16-00-03.png)

click install

![Screenshot from 2017-03-13 16-00-38](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 16-00-38.png)



![Screenshot from 2017-03-13 16-01-19](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 16-01-19.png)

after this, we need to load the license:

![Screenshot from 2017-03-13 16-21-55](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 16-21-55.png)

click "Load License" and "Copy License" (You can find lic file in firmware path [phenix_devkit path]/amp_system/)

![Screenshot from 2017-03-13 16-23-26](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 16-23-26.png)
...
**![Screenshot from 2017-03-14 17-02-33](/home/steven/Pictures/devkit/Screenshot from 2017-03-14 17-02-33.png)**
...
![Screenshot from 2017-03-15 00-25-33](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 00-25-33.png)
...
![Screenshot from 2017-03-20 11-22-15](/home/steven/Pictures/devkit/Screenshot from 2017-03-20 11-22-15.png)
...
![Screenshot from 2017-03-13 18-18-21](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 18-18-21.png)

select "RTL Project"

![Screenshot from 2017-03-13 18-20-01](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 18-20-01.png)

click Next until the UI below

![Screenshot from 2017-03-13 18-42-46](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 18-42-46.png)
...
![Screenshot from 2017-03-20 11-12-12](/home/steven/Pictures/devkit/Screenshot from 2017-03-20 11-12-12.png)

click "Create Block Design", input design name, and click "OK"

![Screenshot from 2017-03-13 18-45-01](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 18-45-01.png)
...
![Screenshot from 2017-03-13 18-50-19](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 18-50-19.png)

click ![Screenshot from 2017-03-13 18-51-36](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 18-51-36.png)and input zynq to search "ZYNQ Processing System",  double click to add it to our design, and click **Run Block Automation**, Vivado will configure PS core with board interface files which we installed int 2.1![Screenshot from 2017-03-13 18-55-06](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 18-55-06.png)

now, the PS core should be like this :

![Screenshot from 2017-03-20 11-18-22](/home/steven/Pictures/devkit/Screenshot from 2017-03-20 11-18-22.png)

connect an input signal for AXI, like the image below:

![Screenshot from 2017-03-20 11-20-49](/home/steven/Pictures/devkit/Screenshot from 2017-03-20 11-20-49.png)
...
![Screenshot from 2017-03-13 19-48-02](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 19-48-02.png)

right mouse click ![Screenshot from 2017-03-13 19-49-26](/home/steven/Pictures/devkit/Screenshot from 2017-03-13 19-49-26.png)and select "Create HDL Wrapper",This will generate a HDL wrapper that the Vivado synthesizer understands.  Once this happens, we are ready to generate our bitfile. This might sound like a large jump, but there isn't anything else in our design - it's almost entirely PS (the only PL portion is that AXI 
port support logic).

next, we need to set "Top moudule name", click "Synthesis Settings"![Screenshot from 2017-03-14 10-46-20](/home/steven/Pictures/devkit/Screenshot from 2017-03-14 10-46-20.png)and "..."button, select phenix_devkit_wrapper:

![Screenshot from 2017-03-14 14-38-02](/home/steven/Pictures/devkit/Screenshot from 2017-03-14 14-38-02.png)
...
![Screenshot from 2017-03-14 15-54-04](/home/steven/Pictures/devkit/Screenshot from 2017-03-14 15-54-04.png)
...
![Screenshot from 2017-03-20 13-38-38](/home/steven/Pictures/devkit/Screenshot from 2017-03-20 13-38-38.png)
...
![Screenshot from 2017-03-14 16-48-32](/home/steven/Pictures/devkit/Screenshot from 2017-03-14 16-48-32.png)

Select **Xilinx_tools > Repositories**

![Screenshot from 2017-03-15 10-14-40](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 10-14-40.png)

select **New** and Browse to and select the directory design\src\sdk_repo, select **OK**

![Screenshot from 2017-03-15 10-16-55](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 10-16-55.png)

### 3.3 Create FSBL Application

Select **File > New > Application_Project**

![Screenshot from 2017-03-15 10-30-11](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 10-30-11.png)

select **New...** button to indicate the hdf file, click **Finish** and **Next**

![Screenshot from 2017-03-15 10-31-51](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 10-31-51.png)

select **Zynq FSBL** and click **Finish**

**![Screenshot from 2017-03-15 11-13-50](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 11-13-50.png)**
...
![Screenshot from 2017-03-15 11-26-33](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 11-26-33.png)

in the Board Support Package settings, select **overview > standalone** and change both stdin and stdout to **ps7\_uart\_1**![Screenshot from 2017-03-15 13-25-28](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 13-25-28.png)

select **Overview > drivers > cpu_cortexa9\_1** and add **-DUSE_AMP=1** to extra_compiler_flags

![Screenshot from 2017-03-15 13-28-40](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 13-28-40.png)

​	Now, we can create bare_metal application, select **File > New > Application Project**, set like image below, and click **Finish**:

![Screenshot from 2017-03-15 13-35-45](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 13-35-45.png)

change the code to a while cycle:

![Screenshot from 2017-03-15 13-46-22](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 13-46-22.png)
...
- modify memory section in devicetree (u-boot-xlnx/arch/arm/dts/zynq-zed.dts):
  ...
  ![Screenshot from 2017-03-15 14-23-34](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 14-23-34.png)
...
![Screenshot from 2017-03-15 14-40-18](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 14-40-18.png)
...
![Screenshot from 2017-03-15 17-03-51](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 17-03-51.png)
...
![webwxgetmsgimg](/home/steven/Pictures/devkit/webwxgetmsgimg.jpg)
...
![Screenshot from 2017-03-15 18-20-28](/home/steven/Pictures/devkit/Screenshot from 2017-03-15 18-20-28.png)
